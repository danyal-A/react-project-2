...
export default function Comments({postid ,modal,setModal}) {
  const history = useNavigate();
 
  const totalcomment = JSON.parse(localStorage.getItem("Comments")) || [];
  ...
  const handleSubmit = (e) =>{
    ...
    const updatedComments = [...totalcomment, newComment];
